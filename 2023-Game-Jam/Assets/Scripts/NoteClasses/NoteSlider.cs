        ...
        public override void Init(PooledObjectCallbackData data, Action<PooledObjectBase> killAction)
        {
            ...
            switch (ownerLane.currentColorEnum)
            {
                case NoteColorEnum.Blue:
                    animatorStart.gameObject.GetComponent<SpriteRenderer>().color = LaneManager.Instance.colorBlue;
                    animatorEnd.gameObject.GetComponent<SpriteRenderer>().color = LaneManager.Instance.colorBlue;
                    this.colorEnum = NoteColorEnum.Blue;
                    break;
                case NoteColorEnum.Red:
                    animatorStart.gameObject.GetComponent<SpriteRenderer>().color = LaneManager.Instance.colorRed;
                    animatorEnd.gameObject.GetComponent<SpriteRenderer>().color = LaneManager.Instance.colorRed;
        ...
        private void UpdateEndNoteHoldStatus()
        {
            ...
            if (_isStartNoteHitCorrect && _isHolding)
            {
                ...
                if (_sliderData.timeStampKeyUp + _gameModeData.SliderHoldStickyTime <= CurrentSongTimeAdjusted) {
                    ...
                    this.FireEvent(EventType.PlayerEndBlock, noteOrientation);
